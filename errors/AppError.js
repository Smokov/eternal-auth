...
class AppError extends Error {
  ...
  toString() {
    ...
    result += "\n";
    if (this.stack) result += this.stack;
...
const appErrors = {
  InvalidInputError: (message, name = null, innerException = null) =>
    new AppError(
      ...
      name || commonErrors.InvalidInput.name,
      innerException
    ),
  ...
  ConflictError: (message, name = null, innerException = null) =>
    new AppError(
      ...
      name || commonErrors.Conflict.name,
      innerException
    ),
  BadFormatError: (message, name = null, innerException = null) =>
    new AppError(
      ...
      name || commonErrors.BadFormat.name,
      innerException
    ),
  UnknownError: (message, name = null, innerException = null) =>
    new AppError(
      ...
      name || commonErrors.UnknownError.name,
      innerException
    )
};
